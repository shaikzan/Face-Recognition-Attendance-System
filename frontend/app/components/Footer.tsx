...
export default function Footer() {
  ...
  const footerLinks = {
    product: [
      ...
      { name: "API Documentation", href: "#how-it-works" },
      { name: "Security", href: "#about" },
      { name: "Integrations", href: "#features" }
    ],
    company: [
      { name: "About Us", href: "#about" },
      { name: "Careers", href: "mailto:contact@facerecsys.com" },
      { name: "Press", href: "mailto:contact@facerecsys.com" },
      { name: "Blog", href: "#features" },
      { name: "Contact", href: "#contact" },
      { name: "Partners", href: "mailto:contact@facerecsys.com" }
    ],
    support: [
      ...
      { name: "Training", href: "/student/demo-session" },
      { name: "Webinars", href: "/student/demo-session" }
    ],
    legal: [
      ...
      { name: "Data Protection", href: "#about" }
    ]
  };
