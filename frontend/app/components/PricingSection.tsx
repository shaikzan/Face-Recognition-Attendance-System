        ...
        <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-3xl p-8 border-2 border-slate-200 shadow-xl text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#contact" className="flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-slate-700 to-slate-800 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                Contact Sales
                <ArrowRight className="w-5 h-5" />
              </a>
              <Link href="/student/demo-session" className="flex items-center justify-center gap-3 px-8 py-4 border-2 border-slate-300 text-slate-700 font-semibold rounded-2xl hover:border-slate-400 transition-all duration-300 bg-white/50">
                Schedule Demo
              </Link>
            </div>
          </div>
