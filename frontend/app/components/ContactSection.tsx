...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {submitted && <p className="text-center text-emerald-700 font-semibold" role="status">Thanks. Your message is ready for our team.</p>}
    </form>
  );
}
    ...
    <section className="py-20">
      ...
      <div className="mt-16 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 border border-blue-200 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/signup" className="px-6 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl">
            Start Free Trial
          </Link>
          <Link href="/student/demo-session" className="px-6 py-3 bg-white text-blue-600 rounded-xl font-semibold border-2 border-blue-200 hover:border-blue-300 transition-colors">
            Schedule Demo
          </Link>
        </div>
      </div>
