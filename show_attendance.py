...
def subjectchoose(text_to_speech):
    def calculate_attendance():
        ...
        filenames = glob(os.path.join(attendance_path, Subject, Subject + "_*.csv"))
        if not filenames:
        ...
        newdf.to_csv(os.path.join(attendance_path, Subject, "attendance.csv"), index=False)

        root = tk.Toplevel(subject)
        root.title("Attendance of "+Subject)
        root.configure(background="black")
        cs = os.path.join(attendance_path, Subject, "attendance.csv")
